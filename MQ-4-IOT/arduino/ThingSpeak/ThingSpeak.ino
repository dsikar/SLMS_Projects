...
//#define USE_ETHERNET_SHIELD
    ...
    // Use WiFi
      ...
      #include <WiFi101.h>
    #endif
    char ssid[] = "Makerversity_2G";    //  your network SSID (name) 
    char pass[] = "mak3rv3rs1ty";   // your network password
...
/*
  ...
  *****************************************************************************************/
unsigned long myChannelNumber = 175534;
const char * myWriteAPIKey = "8SUFSLSSHEEK9WQC";
